...
import { useTournamentStore, useCurrencyStore, playSound } from '@composition/container';
...
import { getBackgroundOptions, getBackgroundPath } from '../config/appConfig';
        ...
        {step === 0 && (
          <div className="space-y-4">
            ...
            <Field label="Projector background">
              ...
              {getBackgroundPath(draft.projectorBackgroundId) && (
                <img
                  src={getBackgroundPath(draft.projectorBackgroundId)}
        ...
        {step === 2 && (
          <div className="space-y-3">
            <p className="text-sm text-themed-muted">
              Customize this tournament&apos;s blind schedule — edit any value, or add/remove levels and breaks.
            </p>
