...
import Slash from './sections/Slash';
import {
  CHIP_RACE_SIZE,
  DIAL_SIZE,
  FINISHED_CLOCK_SIZE,
            ...
            <div key={stat.label} className="flex items-center" style={{ gap: pu(1.2) }}>
              ...
              <span className="flex-1">
                ...
                <span
                  ...
                  style={{ fontSize: pu(STAT_VALUE_SIZE), fontWeight: 600, lineHeight: 1.05 }}
                >
                  {stat.value}
                </span>
              </span>
      ...
      <div className="flex min-h-0 flex-col items-center justify-center overflow-hidden">
        ...
        {m.showBlinds && (
          <div
            ...
            style={{
              // Ledger's figures are half again as wide as the ones this row
              // used to hold, so the gaps between them give up what they took.
              gap: pu(1.2),
              marginTop: pu(0.5),
            }}
          >
            ...
            <Slash />
            <Blind label="Ante" value={m.blinds.ante} />
          </div>
        )}
        <div
          style={{
