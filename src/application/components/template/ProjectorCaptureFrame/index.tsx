...
import { captureProjectorImage } from "@application/shared/captureProjectorImage";
import {
  CAPTURE_STYLE_ATTRIBUTE,
  FRAME_HEIGHT,
  FRAME_WIDTH,
  FREEZE_MOTION_CSS,
} from "./constants";
...
function injectParentStyles(targetDoc: Document) {
  targetDoc
    .querySelectorAll(`style[${CAPTURE_STYLE_ATTRIBUTE}]`)
  ...
  // Last, so it overrides the animations the copied sheet just brought in.
